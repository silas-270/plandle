...
- [ ] **🌌 Große neue Funktion:** Scoreboard / Globale Rangliste
  *Teilaufgaben:*
  ...
  - UI hinzufügen, um im Menü dem Account einen Namen zu geben (Konto-Erstellung Light).
  - Scoreboard UI hinzufügen (Toggle zwischen persönlicher Statistik und globaler Ladder).